	 		...
	 		if(k1.isSelected()) {
	 			...
	 			b1.addActionListener(new ActionListener() {
	 	            ...
	 	            public void actionPerformed(ActionEvent e) {
	 	                ...
	 	                if (Desktop.isDesktopSupported()) {
	 	                    try {
	 	                        Desktop.getDesktop().browse(new URI("https://drive.google.com/file/d/1YL9lk0CO59zHoVkCiCqYwx6-0FwEGU36/view?usp=sharing"));
	 	                    } catch (Exception ex) {
	 	                        ex.printStackTrace();
	 	                    }
	 	                }
	 			...
	 			b1.addActionListener(new ActionListener() {
	 	            ...
	 	            public void actionPerformed(ActionEvent e) {
	 	                ...
	 	                if (Desktop.isDesktopSupported()) {
	 	                    try {
	 	                        Desktop.getDesktop().browse(new URI("https://drive.google.com/file/d/1utyEWZ-xMj6FNPepFMRUkkEfyetEXtt-/view?usp=sharing"));
	 	                    } catch (Exception ex) {
	 	                        ex.printStackTrace();
	 	                    }
	 	                }
